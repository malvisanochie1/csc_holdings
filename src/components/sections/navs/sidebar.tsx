...
const navItems: {
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M12 3C7.03 3 3 6.477 3 11s4.03 8 9 8 9-3.477 9-8-4.03-8-9-8zm1 11h-2v-6h2v6z"
          fill="currentColor"
        />
      </svg>
    ),
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M12 22c1.104 0 2-.896 2-2H10c0 1.104.896 2 2 2zm6-6v-5c0-3.072-1.635-5.641-4.5-6.32V4a1.5 1.5 0 10-3 0v.68C7.635 5.359 6 7.928 6 11v5l-1.999 2H20L18 16z"
          fill="currentColor"
        />
      </svg>
    ),
...
export default function Sidebar({ active }: SidebarProps) {
  ...
  return (
    <aside className="w-full hidden lg:flex h-full overflow-y-auto min-h-screen bg-gray-50/60 border-r border-gray-200 px-6 py-6 flex-col justify-between">
      <div>
