    ...
    <>
      <div className="grid grid-cols-1 lg:grid-cols-5  gap-4 ">
        ...
        <div className="lg:col-span-2 card p-2 sm:p-4">
          <div className="p-2 sm:p-5 bg-gradient-to-br from-[#5FC2C1] to-[#676DD3] card text-white flex flex-col space-y-2 sm:space-y-3">
            <h1 className="text-lg sm:text-xl md:text-2xl font-bold flex items-center">
              <span className="p-1 pb-2 rounded-md bg-white w-7 sm:w-9 h-7 sm:h-9 flex justify-center me-2 text-gray-600">
                <MdDiamond />
              </span>{" "}
            ...
            <p className="sm:text-lg font-[400] leading-snug">
